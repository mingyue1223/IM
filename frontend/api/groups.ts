import type { AddGroupMemberRequest, ApiId, CreateGroupRequest, CreateGroupResponse, Group, GroupMember, Page, UpdateGroupMemberRoleRequest, UpdateGroupRequest } from "../goim-api-types";
