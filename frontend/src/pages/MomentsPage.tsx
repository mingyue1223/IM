...
import { ArrowUp, ChevronDown, CircleAlert, Heart, LoaderCircle, MessageCircle, MoreHorizontal, PenLine, Trash2, Users, UsersRound } from "lucide-react";
...
export function MomentsPage() {
  ...
  const { posts, publish, toggleLike, addComment, deleteComment, isLoading, isError, hasNextPage, fetchNextPage, isFetchingNextPage, isMutating } = useMoments(feedMode);
